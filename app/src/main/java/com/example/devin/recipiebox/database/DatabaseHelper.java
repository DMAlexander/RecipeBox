...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_RECIPIE_NAME = "RecipieName";
    ...
    private static final String COLUMN_INGREDIENT_RECIPIE_ID = "ID";
    ...
    public boolean addRecipieData( String item, String description, String hasIngredients, int FolderID ) {
    ...
    public boolean addShoppingCartData( String recipie, String item, double quantity, String measurementType, int recipeQuantity, String hasIngredients ) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
